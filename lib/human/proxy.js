...
import proxy_clothes_female_sportsuit01 from "makehuman-data/public/data/proxies/clothes/female_sportsuit01/female_sportsuit01.json"
import proxy_eyebrows_eyebrow010 from "makehuman-data/public/data/proxies/eyebrows/eyebrow010/eyebrow010.json"
import proxy_hair_braid01 from "makehuman-data/public/data/proxies/hair/Braid01/Braid01.json"
import proxy_eyes_lowpoly from "makehuman-data/public/data/proxies/eyes/Low-Poly/Low-Poly.json"
            ...
            .then((json) => {
                ...
                const texturePath = self.texturePath &&
                    (typeof self.texturePath === 'string') ?
                        self.texturePath :
                  THREE.LoaderUtils.extractUrlBase(self.url)
...
export class Proxies extends THREE.Object3D {
    ...
    updateFaceMask(minMaskedVertsPerFace = 3) {
        ...
        const nullMaterial = this.human.mesh.material.findIndex(m => m.name === 'maskedFaces')
